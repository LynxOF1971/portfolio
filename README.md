...
Email links open the visitor’s email app. There is no server-side contact form. The résumé opens the original Google Drive link and depends on its owner’s sharing settings. Social and video destinations may require login to their respective services.
